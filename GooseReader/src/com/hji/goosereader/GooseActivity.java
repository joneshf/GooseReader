	...
	public void navigationButtonHandler(View button) {
		...
		// XXX Testing offline.
			...
			case R.id.firstButton:
				...
				break;
			case R.id.previousButton:
				// Don't go past the first comic.
				sPresentComicNumber = (FIRST_COMIC_NUMBER == sPresentComicNumber)
						? FIRST_COMIC_NUMBER : sPresentComicNumber - 1;
				break;
			case R.id.randomButton:
			...
			case R.id.nextButton:
				// Don't go past the last comic.
				sPresentComicNumber = (sCurrentComicNumber == sPresentComicNumber)
						? sCurrentComicNumber : sPresentComicNumber + 1;
				break;
			case R.id.currentButton:
